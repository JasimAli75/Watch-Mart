  ...
  return (
    <div className="flex justify-evenly items-center mt-20 mb-20 bg-slate-200 h-20 rounded-full">
      ...
      <div className="flex items-center gap-3 ">
        ...
        <div>
          <h1 className="text-lg font-semibold">30 days return policy</h1>
          <p className="text-sm">Get your money back for any purchase</p>
        </div>
      </div>
      {/* Free shipping */}
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-lg font-semibold">Free express shipping </h1>
          <p className="text-sm">Free shipping over $200</p>
        </div>
      </div>
      {/* Secure payment */}
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm">Clear pricing and fast payouts</p>
        </div>
      </div>
    </div>
  );
